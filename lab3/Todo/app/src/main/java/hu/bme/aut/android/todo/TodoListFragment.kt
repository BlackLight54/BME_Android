...
import hu.bme.aut.android.todo.placeholder.PlaceholderContent;
...
class TodoListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val itemDetailFragmentContainer: View? = view.findViewById(R.id.todo_detail_nav_container)
    ...
    class SimpleItemRecyclerViewAdapter(
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            ...
            val binding =
                TodoListContentBinding.inflate(LayoutInflater.from(parent.context), parent, false)
            ...
            with(holder.itemView) {
                ...
                setOnClickListener { itemView ->
                    ...
                    if (itemDetailFragmentContainer != null) {
                        ...
                        itemView.findNavController().navigate(R.id.show_todo_detail, bundle)
                    }
                }
        ...
        inner class ViewHolder(binding: TodoListContentBinding) :
